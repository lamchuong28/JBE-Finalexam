...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, UserDetailsService userDetailsService,
		...
		return httpSecurity
				...
				.requestMatchers(HttpMethod.GET,"/variantProduct/**","/products/**", "/categories/**")
				.permitAll()
				.and()
				
				.authorizeHttpRequests()
				.requestMatchers(HttpMethod.POST,"/users/register-user", "/api/auth/login")
				.permitAll()
				.and()
				...
				.authorizeHttpRequests()
				.requestMatchers(HttpMethod.PUT,"/addresses/**")
				.hasAnyRole("ADMIN", "USER")
				.and()
